...
files_to_translate = [
    r"e:\www\iumc\edu\edu\Views\Shared\_Layouthome - Copy.cshtml",
    r"e:\www\iumc\edu\edu\Views\Shared\_Layouthome.cshtml"
]
...
for file_path in files_to_translate:
    if os.path.exists(file_path):
        ...
        for eng, mn in translations.items():
            content = content.replace(eng, mn)
