    ...
    d.app.menu = {
        ...
        manualScroller: {
            ...
            update: function () {
                if (this.obj) {
                    ...
                    if (!0 === d(".main-menu").data("scroll-to-active"))
                        e = 0 < d(".main-menu-content").find("li.active").parents("li").length ? d(".main-menu-content").find("li.active").parents("li").last().position() : d(".main-menu-content").find("li.active").position(), setTimeout(function () {
            ...
            updateHeight: function () {
                "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || (d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height() - d(".main-menu-header").outerHeight() - d(".main-menu-footer").outerHeight()), this.update())
            }
        },
        init: function (e) {
        ...
        change: function (e) {
            ...
            }, a = d("#main-menu-navigation"), i = d(".menu-search"), d(i).change(function () {
                    var e = d(this).val();
                    if (e) {
                        d(".navigation-header").hide(),
                        d(a).find("li a:not(:Contains(" + e + "))").hide().parent().hide();
                        var n = d(a).find("li a:Contains(" + e + ")");
                        n.parent().hasClass("") ? (n.show().parents("li").show().addClass("open").closest("li").children("a").show().children("li").show(), 0 < n.siblings("ul").length && n.siblings("ul").children("li").show().children("a").show()) : n.show().parents("li").show().addClass("open").closest("li").children("a").show()
                    } else
                        d(".navigation-header").show(), d(a).find("li a").show().parent().show().removeClass("open");
        ...
        transit: function (e, n) {
            ...
            e.call(a),
            l.hasClass("vertical-layout") && (l.hasClass("menu-open") || l.hasClass("menu-expanded") ? (d(".menu-toggle").addClass("is-active"), "vertical-menu" === l.data("menu") && d(".main-menu-header") && d(".main-menu-header").show()) : (d(".menu-toggle").removeClass("is-active"), "vertical-menu" === l.data("menu") && d(".main-menu-header") && d(".main-menu-header").hide())),
            setTimeout(function () {
                n.call(a),
        ...
        collapse: function (e) {
            !1 === this.collapsed && ("vertical-menu-modern" == l.data("menu") && (d(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-disc").addClass("ft-circle"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "false")), this.transit(function () {
                    ...
                    "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || (d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height()), d(".main-menu-content").hasClass("ps") || this.manualScroller.enable())
                }))
        },
        ...
        changeMenu: function (e) {
            ...
            "sm" == e || "xs" == e ? (l.removeClass(l.data("menu")).addClass("vertical-layout vertical-overlay-menu fixed-navbar"), d("nav.header-navbar").addClass("fixed-top"), n.removeClass().addClass("main-menu menu-light menu-fixed menu-shadow"), a.removeClass().addClass("navigation navigation-main"), i.removeClass("dropdown mega-dropdown").addClass(""), i.children("ul").removeClass(), s.each(function (e, n) {
                    d(n).find(".mega-menu-sub").find("li").has("ul").addClass("");
                    var a = d(n).children().first(),
                    i = "";
                    a.is("h6") && (i = a.html(), a.remove(), d(n).prepend('<a href="#">' + i + "</a>").addClass(" mega-menu-title"))
                }), i.find("a").removeClass("dropdown-toggle"), i.find("a").removeClass("dropdown-item"), t.removeClass("dropdown").addClass(""), t.find("a").removeClass("dropdown-toggle nav-link"), t.children("ul").find("a").removeClass("dropdown-item"), t.find("ul").removeClass("dropdown-menu"), o.removeClass().addClass(""), d.app.nav.init(), d("ul.dropdown-menu [data-toggle=dropdown]").on("click", function (e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                    d(this).parent().siblings().removeClass("open"),
                    d(this).parent().toggleClass("open")
                })) : (l.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(l.data("menu")), d("nav.header-navbar").removeClass("fixed-top"), n.removeClass().addClass(u), this.drillDownMenu(e), d("a.dropdown-item.nav-has-children").on("click", function () {
        ...
        bind_events: function () {
            ...
            d(".navigation-main").on("mouseenter.app.menu", "li", function () {
                ...
                if (d(".hover", ".navigation-main").removeClass("hover"), l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu")) {
                    ...
                    e.hasClass("") || (n = e.find("span.menu-title").text(), a = e.children("a").attr("href"), "" !== n && ((i = d("<a>")).attr("href", a), i.attr("title", n), i.text(n), i.addClass("menu-title")));
                    var s,
                    ...
                    if (s = e.css("border-top") ? t + e.position().top + parseInt(e.css("border-top"), 10) : t + e.position().top, i.appendTo(".main-menu-content").css({
                            position: "fixed",
                            top: s
                        }), e.hasClass("") && e.hasClass("nav-item")) {
                        e.children("ul:first");
                        o.adjustSubmenu(e)
                    }
                }
                ...
                var n = d(this);
                if (n.addClass("open"), o.expand(n), d(".main-menu").hasClass("menu-collapsible"))
                    return !1;
                ...
                var n = d(this);
                n.is(".disabled") ? e.preventDefault() : l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu") ? e.preventDefault() : n.has("ul") ? n.is(".open") ? n.trigger("close.app.menu") : n.trigger("open.app.menu") : n.is(".active") || (n.siblings(".active").trigger("deactive.app.menu"), n.trigger("active.app.menu")),
                e.stopPropagation()
            }),
            ...
            d(".navigation-main li. > a").on("click", function (e) {
                e.preventDefault()
            }),
            d("ul.menu-content").on("click", "li", function (e) {
                ...
                if (n.is(".disabled"))
                    ...
                    if (n.is(".open"))
                        n.removeClass("open"), o.collapse(n);
                    else {
                        if (n.addClass("open"), o.expand(n), d(".main-menu").hasClass("menu-collapsible"))
                            return !1;
                        n.siblings(".open").find("li.open").trigger("close.app.menu"),
